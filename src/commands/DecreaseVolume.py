...
class DecreaseVolume(Command):
    ...
    def Match(self, query: str):
        if DecreaseVolume.minusCount == 0:
            DecreaseVolume.currentVolume = self.spotify.current_playback()["device"][
                "volume_percent"
            ]
    ...
    def Run(self, data: str):
        ...
        DecreaseVolume.currentVolume = (
            DecreaseVolume.currentVolume if DecreaseVolume.currentVolume > 0 else 0
        )
        self.spotify.volume(DecreaseVolume.currentVolume)
        ...
        if volume < 0 or volume > 100:
            ...
            return [
                (
                    ...
                    "Decrease volume with " + str(volume) + "%",
                    "Spotify",
                    100,
                    100,
                    {},
    ...
    def DecreaseByMinusCharacter(self, query):
        ...
        if 0 == abs(minusDifference) or abs(minusDifference) == 1:
            if minusDifference == 0:
                minusDifference = 1
            DecreaseVolume.currentVolume = (
                DecreaseVolume.currentVolume - int(getSetting("VOLUME_STEP")) * minusDifference
            )
            ...
            if DecreaseVolume.currentVolume < 0:
                ...
                return [
                    (
                        "",
                        "Volume is now set to: " + str(DecreaseVolume.currentVolume),
                        "Spotify",
                        100,
                        100,
                        {},
